package xyz.tusion.baltseahack_androidapp.presentation.calendar
...
class Example3EventsAdapter(val onClick: (Event) -> Unit) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Example3EventsViewHolder {
        return Example3EventsViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.example_3_event_item_view, parent, false))
    }
...
class Example3Fragment : Fragment(), HasBackButton {
            ...
            override fun bind(container: DayViewContainer, day: CalendarDay) {
                ...
                if (day.owner == DayOwner.THIS_MONTH) {
                    ...
                    when (day.date) {
                        ...
                        selectedDate -> {
                            textView.setTextColorRes(R.color.col_dark_blue)
